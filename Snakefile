...
# ==============================================================================
#
# A comprehensive pipeline for Xylella fastidiosa capture sequencing analysis.
#
# Pipeline Phases:
#   Phase 1 (rule all):
...
rule all:
    ...
    input:
        ...
        qc_report = "01.pre-processing/quality_control_report.html",
...
rule multiqc:
    ...
    output:
        report = "01.pre-processing/quality_control_report.html"
    conda:
        "envs/qc.yaml"
    log:
        "logs/multiqc.log"
    ...
    shell:
        ...
        multiqc 01.pre-processing/ \
            --filename quality_control_report.html \
...
rule prepare_alignment_files:
    ...
    shell:
        ...
        # Get list of successfully reconstructed genes
